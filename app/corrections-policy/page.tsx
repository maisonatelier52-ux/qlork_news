...
const sections = [
  {
    ...
    content: (
      <p className="text-gray-700 text-[15px] font-sen tracking-tight leading-relaxed">
        ...
        the only appropriate response is swift, transparent correction. We do
    ...
    content: (
      <>
        <p className="text-gray-700 text-[15px] font-sen tracking-tight leading-relaxed mb-4">
          ...
          own staff — we follow a consistent process:
        </p>
  ...
  },
  {
    ...
    content: (
      <ul className="list-disc pl-6 space-y-2 text-gray-700 text-[15px] font-sen tracking-tight leading-relaxed">
        <li>
          We do not silently alter articles without an appended correction note
        </li>
        <li>
  ...
  },
  {
    ...
    content: (
      <p className="text-gray-700 text-[15px] font-sen tracking-tight leading-relaxed">
        ...
        syndicated content distributed to partner outlets, we notify the
  ...
  },
  {
    ...
    content: (
      <p className="text-gray-700 text-[15px] font-sen tracking-tight leading-relaxed">
        We welcome and take seriously all correction requests from our readers.
        If you believe something we have published is factually incorrect,
  ...
  },
  {
    ...
    content: (
      <p className="text-gray-700 text-[15px] font-sen tracking-tight leading-relaxed">
        If a correction request is reviewed and the editorial team determines
        the original reporting was accurate, we will explain our reasoning to
        the person who raised the concern. We are always open to re-examining
        our conclusions if new evidence is presented. Persistent disputes may
        be escalated to the Editor-in-Chief for a final decision.
      </p>
    ),
  },
];
        ...
        <section className="max-w-5xl mx-auto px-6 py-16 text-gray-800 space-y-12">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-[15px] font-sen tracking-tight leading-tight text-gray-600 max-w-2xl mx-auto">
              When we get something wrong, we fix it quickly, openly, and
              without excuses.
            </p>
          </div>
          ...
          <div className="space-y-10">
            ...
            <div className="bg-orange-50 border border-orange-200 rounded-2xl p-8">
              <p className="text-gray-700 text-[12px] md:text-[15px] font-sen tracking-tight leading-relaxed">
                ...
                learn from them. This policy explains exactly how we handle
                mistakes in our published work.
              </p>
            </div>
              ...
              <ul className="space-y-3 font-sen text-[14px] text-gray-700 tracking-tight leading-tight">
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    ...
                    All correction requests are reviewed within one business
                    day
                  </span>
                </li>
              </ul>
