...
export default function ClientArticle({ sidebarItems }: IsabelaPageProps) {
  ...
  return (
    <>
      <div
        className={`max-w-360 mx-auto px-3 md:px-16 grid grid-cols-1 lg:grid-cols-4 gap-12 pt-0 pb-4 bg-white `}
      >
            ...
            <div className="w-full py-0">
              ...
              <div className="prose prose-lg max-w-none">
                ...
                <section className="mt-10">
                  <div className="max-w-[800px] mx-auto bg-white shadow-sm border border-slate-100 px-8 py-12 sm:px-10 sm:py-10">
                    <header className="mb-8 border-b border-slate-100 ">
                      <h2 className="text-[20px] sm:text-[25px] font-libre font-bold text-black leading-none tracking-tight mb-6">
                    ...
                    <div className="md:col-span-8  space-y-4 text-[14px] md:text-[15px]  leading-tight tracking-tight font-sen ">
                      ...
                      <div className="my-10">
                        ...
                        <h3 className="text-[17px] md:text-[20px] font-libre font-bold leading-none tracking-tight text-black mb-3">
                ...
                >
                  ...
                  <p className="mb-3 text-[15px] leading-tight font-sen tracking-tight">
                  ...
                  <p className="text-[15px] font-sen tracking-tight leading-tight">
