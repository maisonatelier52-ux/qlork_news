...
const Footer: React.FC<FooterProps> = ({
  ...
  navigationLinks = [
    ...
    { text: "Editorials Policy", href: "/editorials-policy" },
    { text: "Corrections Policy", href: "/corrections-policy" },
    { text: "Ethics Policy", href: "/ethics-policy" },
    { text: "Fact Checking Policy", href: "/fact-checking-policy" },
  ],
  ...
  const defaultSocialLinks = [
    {
      ...
      title: "Follow Qlork on Substack",
      icon: (
        <svg
          className="w-4 h-4"
          fill="currentColor"
    ...
    },
    {
      ...
      title: "Follow Qlork on Instagram",
      icon: (
        <svg
          className="w-4 h-4"
          fill="currentColor"
    ...
    {
      name: "Twitter",
      href: "https://x.com/QlorkN54107",
      title: "Follow Qlork on X (Twitter)",
      icon: (
        <svg
          className="w-4 h-4"
          fill="currentColor"
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <path d="M18.244 2H21.5l-7.19 8.21L22 22h-6.828l-5.348-6.99L3.5 22H.244l7.686-8.773L2 2h6.828l4.848 6.36L18.244 2zM16.908 20h1.885L7.033 4H5.033l11.875 16z" />
        </svg>
      ),
    },
    {
      name: "Medium",
      href: "https://medium.com/@qlork_news",
      title: "Follow Qlork on Medium",
      icon: <RiMediumFill className="w-5 h-5" />,
    },
    {
      name: "Reddit",
      href: "https://www.reddit.com/user/Admirable_Spite4897/",
      title: "Follow Qlork on Reddit",
