        ...
        <div className="flex flex-col-reverse lg:flex-row gap-3 items-start">
          <div className="flex-2 space-y-3 mt-0">
            <div className="flex items-center gap-2 text-sm font-semibold text-gray-700">
              ...
              <span className="text-red-600 font-sen tracking-tight leading-tight">
                {topic}
              </span>
            </div>
            <Link href={linkHref} title={title} className="block">
              {/* ✅ h1 → h2: page's only <h1> is the static sr-only in page.tsx */}
              <h2 className="text-[20px] md:text-[25px] font-bold font-libre leading-none md:leading-[1.1] text-gray-900 transition-colors">
                {title}
              </h2>
            </Link>
            <p className="text-[13px] text-gray-700 font-sen tracking-tight leading-tight mb-1">
              {shortdescription}
            </p>
