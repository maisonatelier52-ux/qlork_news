...
// ✅ Fix: inline JSON-LD — crawlers parse synchronously unlike next/script
const jsonLd = {
  "@context": "https://schema.org",
  "@graph": [
    {
      "@type": "WebPage",
      "@id": "https://www.qlork.com/terms-and-conditions#webpage",
      url: "https://www.qlork.com/terms-and-conditions",
      name: "Terms & Conditions | Qlork",
      description:
        "Read Qlork's Terms & Conditions to understand the rules and guidelines for using our website and services.",
      inLanguage: "en-US",
      ...
      breadcrumb: {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 2, name: "Terms & Conditions", item: "https://www.qlork.com/terms-and-conditions" },
        ],
      },
    },
    {
...
export default function TermsConditionsPage() {
  return (
    <>
      {/* ✅ Fix: inline <script> not next/script */}
      <script
      ...
      <div className="bg-white min-h-screen">
        ...
        <section className="max-w-5xl mx-auto px-6 py-16 text-gray-800 space-y-12">
          ...
          <div className="text-center mb-20">
            ...
            {/* ✅ Fix: "Qlork" added to subtitle — keyword now in visible body text */}
            <p className="text-[15px] text-gray-600 font-sen tracking-tight leading-tight max-w-2xl mx-auto">
              These Qlork Terms & Conditions govern your access to and use of
              the Qlork website and services.
            </p>
          </div>
          ...
          <div className="space-y-10">
            ...
            {/* ✅ Fix: intro box now mentions "Qlork" twice in body paragraph text */}
            <div className="bg-orange-50 border border-orange-200 rounded-2xl p-8">
              <p className="text-[12px] md:text-[15px] font-sen tracking-tight leading-tight text-gray-700">
                Accessing or using the Qlork website constitutes agreement to
                the Terms & Conditions outlined here. If any part of these
                Qlork terms is not accepted, the website should not be used.
              </p>
            </div>
            ...
            <div className="pb-12 border-b border-gray-200">
              ...
              <p className="text-gray-700 font-sen tracking-tight leading-tight text-[15px]">
                Using this Qlork website means agreeing to all terms and
                conditions presented here, applicable to all visitors and users.
              </p>
            </div>
            ...
            <div className="pb-12 border-b border-gray-200">
              ...
              <p className="text-gray-700 text-[15px] font-sen tracking-tight leading-tight mb-4">
                All articles, images, videos, and other materials on the Qlork
                site are protected under copyright laws. Unauthorized
              ...
              <p className="text-gray-700 text-[15px] font-sen tracking-tight leading-tight mb-4">
                Access and reading are permitted for personal, non-commercial
                purposes:
              </p>
              ...
              <p className="text-gray-700 text-[15px] font-sen tracking-tight leading-tight mt-4">
                Restricted actions include reproduction, commercial use,
                removal of copyright notices, creating derivative works, or
                scraping content.
              </p>
            </div>
            ...
            <div className="pb-12 border-b border-gray-200">
              ...
              <p className="text-gray-700 text-[15px] font-sen tracking-tight leading-tight mb-4">
                Some Qlork features require registration. Account holders must
                provide accurate information, secure their credentials, and
            ...
            <div className="pb-12 border-b border-gray-200">
              ...
              <p className="text-gray-700 text-[15px] font-sen tracking-tight leading-tight mb-4">
                Posting comments on Qlork implies that submissions do not
                contain illegal, offensive, or misleading content and that
                permission is granted to use, modify, and display the comments.
              </p>
              <ul className="list-disc text-[15px] font-sen tracking-tight leading-tight pl-8 space-y-2 text-gray-700">
            ...
            <div className="pb-12 border-b border-gray-200">
              ...
              <p className="text-gray-700 text-[15px] font-sen tracking-tight leading-tight mb-4">
                Qlork news content aims to be accurate, fair, and balanced.
                Updates or corrections may occur as new information becomes
                available.
              </p>
              <ul className="list-disc pl-8 text-[15px] font-sen tracking-tight leading-tight space-y-2 text-gray-700">
                ...
                <li>
                  Reasonable verification is performed, but absolute accuracy
                  is not guaranteed
                </li>
            ...
            <div className="pb-12 border-b border-gray-200">
              ...
              <p className="text-gray-700 text-[15px] font-sen tracking-tight leading-tight">
                External links or advertisements on Qlork are not endorsed.
                Responsibility for third-party content, accuracy, or privacy
                practices lies with the respective sources.
              </p>
            </div>
            ...
            <div className="pb-12 border-b border-gray-200">
              ...
              <p className="text-gray-700 text-[15px] font-sen tracking-tight leading-tight mb-4">
                Advertisements are displayed on Qlork without influencing
                editorial content. Notifications or alerts are sent responsibly
                and can be managed or disabled by users.
              </p>
            </div>
            ...
            <div className="pb-12 border-b border-gray-200">
              ...
              <p className="text-gray-700 text-[15px] font-sen tracking-tight leading-tight mb-4">
                The Qlork website is provided &quot;as is&quot; without
                warranties. Responsibility for damages, losses, or third-party
                content is limited. Terms are governed by applicable laws of
            ...
            <div className="pb-12">
              ...
              <p className="text-gray-700 text-[15px] font-sen tracking-tight leading-tight mb-4">
                Qlork terms, content, and website features may change. Access
                may be terminated if terms are violated. Continuing use after
                updates constitutes acceptance of the revised Qlork terms.
              </p>
            </div>
