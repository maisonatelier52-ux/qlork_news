...
// ✅ Fix 2: Inline JSON-LD — crawlers read this synchronously at render time
const jsonLd = {
  "@context": "https://schema.org",
  "@graph": [
    {
      "@type": "WebPage",
      "@id": "https://www.qlork.com/privacy-policy#webpage",
      url: "https://www.qlork.com/privacy-policy",
      name: "Privacy Policy | Qlork",
      description:
        "Read Qlork's Privacy Policy to understand how we collect, use, disclose, and safeguard your information when you visit our website.",
      ...
      breadcrumb: {
        ...
        itemListElement: [
          ...
          },
          {
            ...
            position: 2,
            name: "Privacy Policy",
            item: "https://www.qlork.com/privacy-policy",
          },
        ],
      },
    },
...
export default function PrivacyPolicyPage() {
  return (
    <>
      {/* ✅ Fix 2: Inline <script> — not next/script, so crawlers parse it */}
      <script
      ...
      <div className="bg-white min-h-screen">
        ...
        <section className="max-w-5xl mx-auto px-6 py-16 text-gray-800 space-y-12">
          ...
          <div className="text-center mb-16">
            ...
            {/* ✅ Fix 1: "Qlork" added naturally to the subtitle */}
            <p className="text-[15px] font-sen tracking-tight leading-tight text-gray-600 max-w-2xl mx-auto">
              Your privacy matters to Qlork. This policy explains how Qlork
          ...
          <div className="space-y-10">
            ...
            {/* ✅ Fix 1: Intro box — "Qlork" added twice so the keyword
                appears in body paragraph text, not just the heading */}
            <div className="bg-orange-50 border border-orange-200 rounded-2xl p-8">
              <p className="text-gray-700 text-[12px] md:text-[15px] font-sen tracking-tight leading-tight">
                Your privacy is important to Qlork. This Qlork Privacy Policy
                explains how we collect, use, disclose, and safeguard your
                information when you visit our website or use our services.
                Please read carefully. If you do not agree with these terms,
            ...
            {[
                ...
                content: (
                  <>
                    <p className="text-gray-700 leading-relaxed mb-4">
                      We may collect personally identifiable information that
                    ...
                    <p className="text-gray-700 leading-relaxed mt-4">
                      ...
                      address, and other details you choose to provide.
                    </p>
                  </>
                ),
              },
              ...
              },
              {
                ...
                content: (
                  <p className="text-gray-700 leading-relaxed">
                    Qlork uses cookies and similar technologies to track activity
                    on our website and store information. You can configure your
              ...
              },
              {
                ...
                content: (
                  <p className="text-gray-700 leading-relaxed">
                    Qlork implements technical and organizational measures to
                    protect your data, but no method of online transmission or
                    storage is 100% secure. Absolute security cannot be
                    guaranteed.
                  </p>
                ),
              },
              {
                ...
                content: (
                  <ul className="list-disc pl-6 space-y-2 text-gray-700">
                    ...
                    <li>
                      <strong>Data Portability:</strong> Receive data in
                      portable format
                    </li>
                  </ul>
                ),
              },
              {
                ...
                content: (
                  <p className="text-gray-700 leading-relaxed">
                    ...
                    responsible for their privacy practices. Review their
              ...
              },
              {
                ...
                content: (
                  <p className="text-gray-700 leading-relaxed">
                    Our services are not directed at children under 13. We do
                    not knowingly collect data from children. Contact us if you
              ...
              },
              {
                ...
                content: (
                  <p className="text-gray-700 leading-relaxed">
                    Qlork may update this Privacy Policy periodically. Updates
            ...
            {/* ✅ Fix 1: Closing note — final "Qlork" repetition in body text */}
            <div className="bg-gray-50 border border-gray-200 rounded-2xl p-8">
              <p className="text-gray-700 text-[12px] md:text-[15px] font-sen tracking-tight leading-tight">
                If you have any questions about this Qlork Privacy Policy or
                our data practices, please contact us through our website. Qlork
                is committed to protecting your privacy and handling your
